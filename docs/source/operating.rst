[finalattempt-a89c] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [finalattempt-a89c] container is NOT running**.

.. tip::
   You must have your [finalattempt-a89c] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Hooluwole/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39365  \-\-env VIPERVIZPORT=50913  \-\-env GITUSERNAME='Hooluwole'  \-\-env DOCKERUSERNAME='hooluwole70'  \-\-env MQTTUSERNAME='hooluwole70'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:50913/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:50913/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 43415:43415 -p 54103:54103 -p 36773:36773 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=finalattempt-a89c \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-finalattempt-a89c \-\-env GITUSERNAME=Hooluwole  \-\-env GITREPOURL=https://github.com/Hooluwole/raspberrypi \-\-env SOLUTIONEXTERNALPORT=43415  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=54103  \-\-env SOLUTIONVIPERVIZPORT=36773 \-\-env DOCKERUSERNAME='hooluwole70' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=39365 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=50913 \-\-env MQTTUSERNAME='hooluwole70' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hooluwole70/finalattempt-a89c-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - hooluwole70/finalattempt-a89c-amd64
...
[finalattempt-a89c] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Hooluwole/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/finalattempt-a89c
...
.. important::
   solution_preprocessing_ai_mqtt_dag-finalattempt-a89c
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=43415, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=40975, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43321, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34909, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=46049, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41409, HPDEHOST=127.0.1.1, HPDEPORT=43347, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46063

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8267-finalattempt-a89c,solution_preprocessing_ai_mqtt_dag-finalattempt-a89c, python-preprocess-2630-finalattempt-a89c,solution_preprocessing_ai_mqtt_dag-finalattempt-a89c, python-ai-5955-finalattempt-a89c,solution_preprocessing_ai_mqtt_dag-finalattempt-a89c, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
