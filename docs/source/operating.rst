...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Hooluwole/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40065  \-\-env VIPERVIZPORT=59517  \-\-env GITUSERNAME='Hooluwole'  \-\-env DOCKERUSERNAME='hooluwole70'  \-\-env MQTTUSERNAME='hooluwole70'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:59517/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:59517/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=48965, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42553, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36239, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35457, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35395, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37191, HPDEHOST=127.0.1.1, HPDEPORT=42129, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35399

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3880-finalattempt-a89c,solution_preprocessing_ai_mqtt_dag-finalattempt-a89c, python-preprocess-2964-finalattempt-a89c,solution_preprocessing_ai_mqtt_dag-finalattempt-a89c, python-ai-4842-finalattempt-a89c,solution_preprocessing_ai_mqtt_dag-finalattempt-a89c, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
